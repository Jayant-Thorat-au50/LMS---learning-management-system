    ...
    return (
        <HomeLayout>
            ...
            <div className=' pt-20 text-white bg-[rgb(255,255,255)] flex flex-col px-14 gap-16   min-h-[90vh]'>
                ...
                <div className='rounded-md w-full bg-blue-50 h-[28rem] lg:w-[57%] space-y-6 flex flex-col justify-center items-start px-10 '>
            ...
            <div className=' w-full px-7  '>
                {catagoryList.map(catagory => <CourseListByCat catagory={catagory} />)}
            </div>
            </div>
